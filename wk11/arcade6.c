 ...
 * This implementation refactors much of the function definitions and macros to
 * a header file, arcade_header.h. The same has been done for the source code 
 * of our arcade's games
 * @version 0.1
 * @date 2022-11-15
 * 
